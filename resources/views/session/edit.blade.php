                                    ...
                                    <div class="fm-search">
                                        <div class="mb-0">
                                            ...
                                            <div class="input-group input-group-lg"> <span
                                                ...
                                                <input type="hidden" name="image" value="{{ $session->titleimage }}"
                                                    id="">
                                        ...
                                        <div class="mb-0">
                                            ...
                                            <div class="input-group input-group-lg"> <span
                                                ...
                                                <input type="text" class="form-control"
                                                    value="{{ $session->nameSession }}" name="name"
                                    ...
                                    <div class="fm-search">
                                        <div class="mb-0">
                                            ...
                                            <div class="input-group input-group-lg"> <span
                                                    class="input-group-text bg-transparent"><i
                                                        class='bx bx-search'></i></span>
                                                <input type="text" class="form-control" value="{{ $session->session }}"
                                                    name="session" placeholder="How many session?">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="fm-search">
                                        <div class="mb-0">
                                            ...
                                            <div class="input-group input-group-lg"> <span
                                                    class="input-group-text bg-transparent"><i
                                                        class='bx bx-search'></i></span>
                                                <input type="text" class="form-control" value="{{ $session->lession }}"
                                                    name="lession" placeholder="How many lession ?">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="fm-search">
                                    ...
                                    <div class="fm-search">
                                        <div class="mb-0">
                                            ...
                                            <div class="input-group input-group-lg">
                                                <div class="btn-group" role="group"
                                                    ...
                                                    <input type="radio" class="btn-check" name="role"
                                                        id="btnradio1" checked value="1" autocomplete="off" checked>
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" value="{{ $session->cost }}"
                                                    name="cost" placeholder="Input group cost for session"
