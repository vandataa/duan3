...
<!-- Mirrored from codervent.com/syndash/demo/vertical/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 22 Jul 2023 16:02:55 GMT -->
<head>
	<!-- Required meta tags -->
	<meta charset="utf-8" />
...
<body>
	...
	<div class="wrapper">
		...
		<!--header-->
        <header>
            @include('layoutindex.header')
        </header>
        <div>
            @yield('content')
        </div>
        <footer>
            @include('layoutindex.footer')
        </footer>
    </body>
</div>
<!-- end wrapper -->
...
<!-- Mirrored from codervent.com/syndash/demo/vertical/file-manager.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 22 Jul 2023 16:05:28 GMT -->
</html>
