            ...
            <div class="page-content">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{ route('lession.update', $lession->id) }}" enctype="multipart/form-data"
                            method="post">
                            @csrf
                            @method('PUT')
                            <div class="card-body">
                                <div class="fm-search">
                                    <div class="mb-0">
                                        ...
                                        <div class="input-group input-group-lg"> <span
                                            ...
                                            <input type="text" class="form-control" value="{{ $lession->nameLession }}"
                                                name="name" placeholder="Name your lession">
                                        </div>
                                    </div>
                                </div>
                                <div class="fm-search">
                                ...
                                <div class="fm-search">
                                    <div class="mb-0">
                                        ...
                                        <div class="input-group input-group-lg"> <span
                                                class="input-group-text bg-transparent"><i class='bx bx-search'></i></span>
                                            <textarea name="description" id="" cols="30" rows="10">{{ $lession->description }}</textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="fm-search">
                                        ...
                                        <div class="input-group input-group-lg"> <span
                                            ...
                                            <select class="form-select" name="session" aria-label="Default select example">
                                                ...
                                                @foreach ($session as $session)
                                                    @if ($lession->id_session === $session->id)
